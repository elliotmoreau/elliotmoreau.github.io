...
<body>
  <nav id="main-nav">
    <div class="container">
      ...
      <div class = 'social'>
        <a href="feeds/all.php" target = 'blank'><i class="fa-solid fa-square-rss fa-2x"></i></a>
        <div class="none">
        ...
        <a href="https://www.youtube.com/channel/UCGNIhM1qkrQvTD32q-fDcWw/featured" target = 'blank'><i class="fab fa-youtube fa-2x"></i></a>
      </div>
      <ul>
