...
<head>
  ...
  <title>La Gazette Tulliste | Contacter</title>
</head>
<body>
  <nav id="main-nav">
    <div class="container">
  ...
  <section id="about">
    <div class="container">
      <div class="page-container">
        <article class="card">
          <h1 class='l-heading'>Vous voulez nous contacter ?</h1>
          <p>Nous sommes disponibles a l'adresse suivantes : email@fournisseur.com.</p>
          <p><b>Veuillez ne pas spammer cette adresse email.</b></p>
          <br><br>
          <h1 class='l-heading'>Vous voulez nous partager une actualité ?</h1>
          <p>Nous sommes disponibles a l'adresse suivante : partager@fournisseur.com.</p>
          <p><b>Veuillez uniquement envoyer des mails partageants une actualité dans les autres cas utilisez : contacter@fournisseur.com.</b></p>
        </article>
